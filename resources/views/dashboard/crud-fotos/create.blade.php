...
@section('content')
    ...
    <div class="flex items-center justify-center h-screen mx-4">
        ...
        <x-card>
            ...
            <img src="{{ asset('img/DSC_1837.JPG') }}" class="fixed inset-0 -z-200 h-screen bg-cover bg-center w-full">
