...
<?php $component = App\View\Components\Ui\Input::resolve(['type' => 'text','placeholder' => 'Nombre del usuario','name' => 'name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal380f71552d26da11981188819389cf5c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal380f71552d26da11981188819389cf5c = $attributes; } ?>
<?php $component = App\View\Components\Ui\Input::resolve(['type' => 'password','placeholder' => '************','name' => 'password_confirmation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = App\View\Components\Ui\Link::resolve(['href' => ''.e(route('login.view')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'registerButton']); ?>
...
</html><?php /**PATH C:\Users\frank\Raymi-LLaqta-CMS\resources\views/auth/register.blade.php ENDPATH**/ ?>